...
$(document).ready(function() {
		...
		$("#ticket").click(function(){
         ...
         // alert($("#daterangepicker1").val());
			var veri = $("#daterangepicker1").val();
			
                        $.ajax({
              url:"yazi_isleri_raporlama-gerceklestirme_islemi.php",
              type:"POST",
              data:"tarihislemi="+veri,
