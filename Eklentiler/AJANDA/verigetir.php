...
<body>
    <?php
         include_once '../../Sayfalar/VTYS-CONNECT.php';
  ...
  if(isset($_GET["ekle"])){
     ...
     $ekle =  mysql_query("INSERT INTO yazi_isleri_ajanda(id,veri,tarih,baslangicSaat,bitisSaat,renk)"
     ...
     $ekle =  mysql_query("DELETE FROM yazi_isleri_ajanda WHERE id=$idle");
     mysql_close();
     ...
     $ekle =  mysql_query("UPDATE yazi_isleri_ajanda SET veri='$guncelle', "
