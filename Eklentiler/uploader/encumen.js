...
Dropzone.options.myAwesomeDropzone = {
       ...
       init:function(){
         ...
         this.on("addedfile",function(file){
               ...
               $.ajax({
                   type:"POST",
                   url:"yazi_isleri_encumen-birimi-dosyaYukle.php",
                   data:{
            ...
            this.on("removedfile",function(file){
               // alert("Silinen :"+file.name);
                 ...
                 $.ajax({
                  ...
                  url:"yazi_isleri_encumen-birimi-dosyaYukle.php",
                  acceptedFiles: "application/pdf,image/jpeg,.rar,.png,.gif,.jpg,.docx,.doc,.xlsx,.txt", //hangi tipte veriler ekleyebilir
