...
<body>
 ...
 <div class="col-lg-10 col-lg-offset-1">
         ...
         <div class="panel panel-default">
             <div class="panel-heading clearfix"><b style="font-size:20px;"><i class="fa fa-phone"></i> İletişim Bilgileri</b>
   	...
   	<button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse01"
    		aria-expanded="false" aria-controls="collapse01"><i class="fa fa-bars"></i></button>
    			...
    			<div class="panel-body collapse" id="collapse01">
                            <div class="row">
                                <div class="col-lg-6">
                                     <label for="adim" style="font-size:18px;"><b>Adım</b> </label>      
                                     <label><b>--</b></label>
                                </div>
      
                                <div class="col-lg-6">
                                     <label for="soyadim" style="font-size:18px;"><b>Soyadım</b> </label>      
                                        <label><b>--</b></label>
                                </div>
                           
                          
                                <div class="col-lg-6">
                                     <label for="unvan" style="font-size:18px;"><b>Ünvanım</b> </label>      
    			  <label><b>--</b></label>
                                ...
                                <div class="col-lg-6">
                                    <label for="ulke" style="font-size:18px;"><b>Ülke</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                            
                           
                                <div class="col-lg-6">
                                    <label for="sehir" style="font-size:18px;"><b>Şehir</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                            
                           
                                <div class="col-lg-6">
                                    <label for="ilce" style="font-size:18px;"><b>İlçe</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                           
                           
                                <div class="col-lg-6">
                                    <label for="semt" style="font-size:18px;"><b>Semt</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                           
                            
                                <div class="col-lg-6">
                                    <label for="cep1" style="font-size:18px;"><b>Cep Telefonu</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                            
                           
                                <div class="col-lg-6">
                                    <label for="cep2" style="font-size:18px;"><b>Cep Telefonu 2</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                            
                           
                                <div class="col-lg-6">
                         <label for="adim" style="font-size:18px;"><b>Elektronik Posta :</b> </label>      
    			  <label><b>--</b></label>
                                </div>
                            </div>
         ...
         <div class="panel panel-default">
             <div class="panel-heading clearfix"><b style="font-size:20px;"><i class="fa fa-user"></i> Kişisel Bilgileri</b>
    				<div class="pull-right">
                                      <button type="button" class="btn btn-warning waves-effect waves-light"
    			...
    			<div class="panel-body collapse" id="collapse02">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <label style="font-size:18px;">Cinsiyetim :</label>
                                      <label><b>--</b></label>
                                </div>
                                
                                <div class="col-lg-6">
                                    <label style="font-size:18px;">Doğum Tarihi :</label>
                                      <label><b>--</b></label>
                                </div>
                                <div class="col-lg-6">
                                    <label style="font-size:18px;">Doğum Yeri : </label>
                                      <label><b>--</b></label>
                                </div>
                                <div class="col-lg-6">
                                     <label style="font-size:18px;">Medeni Durum :</label>
                                      <label><b>--</b></label>
                                </div>
                               
                                
                                  <div class="col-lg-6">
                                      <label style="font-size:18px;">Askerlik Durumu : </label>
                                        <label><b>--</b></label>
                                  </div>
                                <div class="col-lg-6" >
                                       <label style="font-size:18px;">Sürücü Belgesi :</label>
                                        <label><b>--</b></label>
                                </div>
   	...
   	<button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse03"
    		aria-expanded="false" aria-controls="collapse03"><i class="fa fa-bars"></i></button>
    			...
    			<div class="panel-body collapse" id="collapse03">
                            <div class="row">
                                <div class="col-lg-9">
                                    <label style="font-size:18px;"><b>Eğitim Seviyesi :</b></label>
                                      <label><b>--</b></label>   
                                </div>
                                 <div class="col-lg-7">
                                     <label style="font-size:18px;"><b>Üniversite Adı :</b></label>
                                      <label><b>--</b></label>
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Şehir :</b></label>
                                     <label><b>--</b></label>
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Fakülte Adı :</b></label>
                                     <label><b>--</b></label>
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Bölüm Adı :</b></label>
                                    <label><b>--</b></label>
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Lise :</b></label>
                                     <label><b>--</b></label>     
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Orta Öğretim :</b></label>
                                     <label><b>--</b></label>     
                                </div>
                                <div class="col-lg-7">
                                    <label style="font-size:18px;"><b>Eklenen Notlar :</b></label>
                                     <label><b>--</b></label>     
                                </div>
                                </div>
    			...
    			<div class="panel-body collapse" id="collapse04">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    ...
                                    <label style="font-size:18px;"><b>İş Deneyimleri : </b></label>
                                    <label>--</label>
                                </div>
                            </div>
   	...
   	<button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse05"
    		aria-expanded="false" aria-controls="collapse05"><i class="fa fa-bars"></i></button>
    			...
    			<div class="panel-body collapse" id="collapse05">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <label style="font-size:18px;"><b>Yetkinlikler : </b></label>
                                    <label>--</label>
                                </div>
                            </div>
   	...
   	<button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse06"
    		aria-expanded="false" aria-controls="collapse06"><i class="fa fa-bars"></i></button>
    			...
    			<div class="panel-body collapse" id="collapse06">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <label style="font-size:18px;"><b>Projeler : </b></label>
                                    <label>--</label>
                                </div>
                            </div>
   	...
   	<button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapse07"
    		aria-expanded="false" aria-controls="collapse07"><i class="fa fa-bars"></i></button>
    			...
    			<div class="panel-body collapse" id="collapse07">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <label style="font-size:18px;"><b>Ek Bilgiler : </b></label>
                                    <label>--</label>
                                </div>
                            </div>
 ...
 <!-- MODAL  KİSİSEL END -->
    ...
    <div id="members-sidebar" class="members-sidebar">
      <h4 class="pull-left zero-m">Hatırlatma</h4>
        ...
        <li>
          <div class="messages">
            <div class="member-info">
              ...
              <span class="member-name">aa</span>
              <p class="members-message zero-m">Sushi time)))</p>
            </div>
            <div class="member-info">
              <img src="img/team/admin.png" alt="admin" class="img-circle pull-left">
              <span class="member-name">aa</span>
              <p class="members-message zero-m">İş Süreci</p>
            </div>
          </div>
        </li>
        <li class="members-group">İş</li>
        <li><span class="status online"></span>aa</li>
        <li><span class="status online"></span>aa</li>
        <li><span class="status not-available"></span>aa</li>
        <li><span class="status"></span>aa</li>
        <li><span class="status"></span>aa</li>
        <li><span class="status"></span>aa</li>
        <li><span class="status"></span>aa</li>
        <li><span class="status"></span>aa</li>
