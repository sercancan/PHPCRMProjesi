...
/* -- color classes -- */
.coralbg {
    background-color: #FFC107;//#FA396F;
} 
        ...
        <div class="col-md-6 user-details">
            <div class="row coralbg white">
                <div class="col-md-6 no-pad">
                    <div class="user-pad">
                        <h3>Mehmet Yüksel</h3>
                        <h4 class="white"><i class="fa fa-check-circle-o"></i>Malatya , İstanbul,Sultangazi</h4>
                        <h4 class="white"><i class="fa fa-twitter"></i> @mhtyksl</h4>
                         <h4 class="white"><i class="fa fa-facebook"></i>Mehmet Yüksel</h4>
                          
                        <a  class="btn btn-labeled btn-info" href="ozgecmis-ayrinti.php">
                            <span class="btn-label"><i class="fa fa-pencil"></i></span>Ayrıntıla</a>
                    </div>
                </div>
                <div class="col-md-6 no-pad">
            ...
            <div class="row overview">
                <div class="col-md-4 user-pad text-center">
                    <h3>Sisteme Toplam Giriş</h3>
                    <h4>159</h4>
                </div>
                <div class="col-md-4 user-pad text-center">
                    <h3>Sistemde Geçirdiği Süre</h3>
                    <h4>456</h4>
                </div>
                <div class="col-md-4 user-pad text-center">
                    <h3>Proje Sayısı</h3>
