...
$metin = "<rows>
  ...
  $a = opendir("../DATAS/meclis-birimi-uploaded");
  $say = 0;
                while($b = readdir($a)){
                    if(($b === "." ) OR ($b === "..")){
                        continue;
                        ...
                        $metin .= "<cell>
                            <![CDATA[
                              <img  src='./Dosyalama-Sistemi/TreeViewIcons/folderis.png' height='20px' width='20px'/>
                                   ...
                                   $metin .= "<cell>
                                            <![CDATA[
                                            <a href='../yazisleri/DATAS/meclis-birimi-uploaded/$b'>$b</a>
                                                ]]>
                                    </cell>
                                    <cell>".date("d.m.Y H:i",fileatime("../DATAS/meclis-birimi-uploaded/$b"))."</cell>
                                     <cell>".filesize("../DATAS/meclis-birimi-uploaded/$b")."</cell>
      ...
      $metin .=  "</rows>";
                ...
                $dosya = fopen('xml-meclis-Cekilen.xml', 'w');
            fwrite($dosya, $metin);
                    fclose($dosya);
