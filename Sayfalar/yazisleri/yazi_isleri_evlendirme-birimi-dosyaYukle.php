...
<body>
    ...
    $storeFolder = 'DATAS/evlendirme-birimi-uploaded';   //2
...
if(isset($_POST["Veriekle"])){
 ...
 $ekleQuery = "INSERT INTO dosya_klasor_bilgiler 
        ...
        VALUES ('$dosyaismi','$dosyaAciklama','$dosyaYuklenmeTarihi','$yukleyenKisi','$dosyaBoyutu','evlendirme')";
...
if(isset($_POST["filename"])){
    ...
    unlink("DATAS/evlendirme-birimi-uploaded/{$silinecek}");
