...
// include './sidebarr.php'; 
 ...
 <div class="col-lg-9 col-lg-offset-1">
  ...
  <div class="col-lg-9 col-lg-offset-1">   
         <h1 id="isreal" ><?php  echo ucfirst($dizi[$m]) ." "; ?></h1>
  </div>
    ...
    ?>
        <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"
                   ...
                   data-src="<?php echo "./albums/$dizi[$m]/$veris"; ?>"
                   data-sub-html="<h4>Muğla Açıkları</h4><p>Sevilen.</p>"
                   data-pinterest-text="<?php echo "albums/$dizi[$m]/$veris";?>" 
                   data-tweet-text="share on twitter 1">
                    <a href="">
                        <img class="img-responsive" src="<?php echo "albums/$dizi[$m]/$veris";?>" alt="Thumb-1" 
                             width="129" height="98"/>
                    </a>
       </div>  
          <?php 
 ...
 <script>
         //  var  num = document.getElementById("sayi").innerHTML;
          ...
          lightGallery(document.getElementById('contic'));
