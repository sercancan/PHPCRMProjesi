...
<body>
   ...
   require_once '../VTYS-CONNECT.php';
    ...
    $storeFolder = 'DATAS/evrak-kayit-birimi-uploaded';   //2
...
if(isset($_POST["Veriekle"])){
 ...
 $ekleQuery = "INSERT INTO dosya_klasor_bilgiler 
        ...
        VALUES ('$dosyaismi','$dosyaAciklama','$dosyaYuklenmeTarihi','$yukleyenKisi','$dosyaBoyutu','evrak-kayit')";
...
if(isset($_POST["filename"])){
    ...
    unlink("DATAS/evrak-kayit-birimi-uploaded/{$silinecek}");
