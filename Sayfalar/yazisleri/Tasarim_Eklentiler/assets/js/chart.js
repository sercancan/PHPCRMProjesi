...
function initFlot() {
	...
	var data3 = [[1, 40], [2, 65], [3, 70], [4, 25], [5, 73],[6, 78], [7, 65], [8, 56], [9, 47], [10, 34],[11, 19],[12, 62]];
	var data4 = [[1, 35], [2, 55], [3, 65], [4, 80], [5, 34],[6, 41], [7, 82], [8, 75], [9, 29], [10, 65],[11, 37],[12, 34]];
	var data5 = [[1, 30], [2, 60], [3, 60], [4, 90], [5, 54],[6, 31], [7, 59], [8, 15], [9, 34], [10, 78],[11, 46],[12, 76]];
	var data6 = [[1, 30], [2, 45], [3, 70], [4, 85], [5, 67],[6, 52], [7, 23], [8, 63], [9, 30], [10, 18],[11, 28],[12, 91]];
	...
	var dataSet3 = [
		{ label: "Meclis", data: data3, color: "#e74c3c" },
		{ label: "Encümen", data: data4, color: "#f39c12" },
		{ label: "Arşiv", data: data5, color: "#2ecc71" },
		{ label: "Evlendirme", data: data6, color: "#3498db" },
                { label: "Evrak Kayıt", data: data6, color: "#8842AC" }
	]
	var dataSet4 = [
	...
	var bar_chart = $.plot($("#chart-bar"), dataSet3, {
		...
		xaxis: {
			ticks: [[1, "Ocak"], [2, "Şuba  t"], [3, "Mart"], [4, "Nisan"], [5, "Mayıs"], [6, "Haziran"],[7, "Temmuz"],[8, "Ağustos"],[9, "Eylül"],[10, "Ekim"],[11, "Kasım"],[12, "Aralık"]],
                        //ticks: [[1, "Jan"], [2, "Feb"], [3, "Mar"], [4, "Apr"], [5, "May"],[6, "Haz"],[7, "Tem"],[8, "Ags"]],
			tickDecimals: 0
		},
		yaxis: {
			ticks: 8,
