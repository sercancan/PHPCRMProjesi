...
<body>
   ...
   require_once '..//VTYS-CONNECT.php';
    ...
    $storeFolder = 'DATAS/arsiv-birimi-uploaded';   //2
...
if (!empty($_FILES)) {
 ...
 $ekleQuery = "INSERT INTO dosya_klasor_bilgiler 
        ...
        VALUES ('$dosyaismi','$dosyaAciklama','$dosyaYuklenmeTarihi','$yukleyenKisi','$dosyaBoyutu','arsiv')";
...
if(isset($_POST["silinecekDosyadi"])){
     $silinecek = $_POST["silinecekDosyadi"];
    
    unlink("DATAS/arsiv-birimi-uploaded/{$silinecek}");
