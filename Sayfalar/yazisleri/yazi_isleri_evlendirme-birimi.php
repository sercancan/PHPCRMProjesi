...
<head>
  <?php require 'LNKLER.php'; ?>
     ...
     <script src="../../Eklentiler/uploader/evlendirme.js" type="text/javascript"></script>
      <link href="../../CSSS/birimlerim-kodu.css" rel="stylesheet" type="text/css"/>     
</head>
<body>
  
 <?php include 'sidebarr.php'; include "../VTYS-CONNECT.php"?>    
      <!--Content-->
 ...
 <div class="col-lg-7 col-lg-offset-2">
  ...
  <!-- <div class="overlay"></div> -->
              ...
              <h1 class="page-header">Evlendirme Dosya Yükleme Merkezi</h1>
          <div class="jquery-script-ads" style="margin:30px auto;">
              <script type="text/javascript">
                      ...
                      <div class="panel panel-default" >
                        ...
                        <form action="yazi_isleri_evlendirme-birimi-dosyaYukle.php" class="dropzone decoration" id="my-awesome-dropzone">
                      </form>
                        </div>
                       ...
                       <div id="ajaxdanGelenVeri"></div>
                         <p><a class="btn btn-default btn-lg" href="raporlama.php?Birimadi=evlendirme-birimi" role="button">Meclis Raporlama &raquo;</a></p>
                ...
                <div class="w-content big-box">
                  <div class="w-progress">
                      <span class="w-amount yellow">
                           <?php 
                        $kdr = "SELECT * FROM dosya_klasor_bilgiler WHERE yukleyen_birim='evlendirme'";
                    ...
                    <br>
                    <span class="text-uppercase w-name">Evlendirme Birimindeki Dosya Sayısı</span>
                  </div>
        ...
        <div class="col-lg-4 col-lg-offset-1">
          ...
          <div class="content-box biggest-box yellow-bg">
            ...
            <div class="pull-left">
             ...
             Birimlerdeki_Klasorlere_Yuklenen_Dosya_Boyutu("evlendirme");
