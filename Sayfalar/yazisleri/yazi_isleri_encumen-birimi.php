...
<head>
  <?php require 'LNKLER.php'; ?>
     ...
     <script src="../../Eklentiler/uploader/encumen.js" type="text/javascript"></script>
              ...
              <script type="text/javascript">
                      ...
                      <div class="panel panel-default" >
                       ...
                       <div id="ajaxdanGelenVeri"></div>
                         <p><a class="btn btn-default btn-lg" href="raporlama.php?Birimadi=encumen-birimi" role="button">Meclis Raporlama &raquo;</a></p>
 ...
 <div class="col-lg-5 col-lg-offset-2">
                ...
                <div class="w-content big-box">
                  <div class="w-progress">
                      <span class="w-amount yellow">
                           <?php 
                        $kdr = "SELECT * FROM dosya_klasor_bilgiler WHERE yukleyen_birim='encumen'";
                    ...
                    <br>
                    <span class="text-uppercase w-name">Encümen Birimindeki Dosya Sayısı</span>
                  </div>
   ...
   <!-- YUKLU DOSYALARIN MB-GB CINSINDEN DEGER WIDGETI START-->
        <div class="col-lg-4 col-lg-offset-1">
          ...
          Birimlerdeki_Klasorlere_Yuklenen_Dosya_Boyutu("encumen");
                  ?>
